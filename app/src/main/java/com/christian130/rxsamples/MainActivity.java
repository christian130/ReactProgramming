...
public class MainActivity extends AppCompatActivity implements MainRecylerAdapter.OnPostClickListener {
    ...
    private void retrievePosts(){
        SrvImplSrvIntAllDeclare.getRequestApi()
                .getPosts()
                .subscribeOn(Schedulers.io())
    ...
    private void initRecyclerView(){
        adapter = new MainRecylerAdapter(this);
